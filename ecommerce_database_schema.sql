...
-- Complete schema for admin and user e-commerce features
...
CREATE INDEX idx_products_season ON ecommerce_products(season);
...
CREATE INDEX idx_products_created ON ecommerce_products(created_at DESC);
